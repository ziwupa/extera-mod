...
.method static constructor <clinit>()V
    ...
    .line 5
    new-instance v1, Lcom/yandex/mapkit/navigation/automotive/RouteStatus;

    const-string v2, "NOT_ON_ROUTE"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3}, Lcom/yandex/mapkit/navigation/automotive/RouteStatus;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/yandex/mapkit/navigation/automotive/RouteStatus;->NOT_ON_ROUTE:Lcom/yandex/mapkit/navigation/automotive/RouteStatus;

    .line 6
    new-instance v2, Lcom/yandex/mapkit/navigation/automotive/RouteStatus;

    const-string v3, "ROUTE_FINISHED"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lcom/yandex/mapkit/navigation/automotive/RouteStatus;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/yandex/mapkit/navigation/automotive/RouteStatus;->ROUTE_FINISHED:Lcom/yandex/mapkit/navigation/automotive/RouteStatus;

    .line 7
    new-instance v3, Lcom/yandex/mapkit/navigation/automotive/RouteStatus;

    const-string v4, "ROUTE_LOST"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5}, Lcom/yandex/mapkit/navigation/automotive/RouteStatus;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/yandex/mapkit/navigation/automotive/RouteStatus;->ROUTE_LOST:Lcom/yandex/mapkit/navigation/automotive/RouteStatus;

    .line 8
    new-instance v4, Lcom/yandex/mapkit/navigation/automotive/RouteStatus;

    const-string v5, "RETURNED_TO_ROUTE"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Lcom/yandex/mapkit/navigation/automotive/RouteStatus;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lcom/yandex/mapkit/navigation/automotive/RouteStatus;->RETURNED_TO_ROUTE:Lcom/yandex/mapkit/navigation/automotive/RouteStatus;

    .line 9
    new-instance v5, Lcom/yandex/mapkit/navigation/automotive/RouteStatus;

    const-string v6, "WAY_POINT_REACHED"

    const/4 v7, 0x5

    invoke-direct {v5, v6, v7}, Lcom/yandex/mapkit/navigation/automotive/RouteStatus;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/yandex/mapkit/navigation/automotive/RouteStatus;->WAY_POINT_REACHED:Lcom/yandex/mapkit/navigation/automotive/RouteStatus;
