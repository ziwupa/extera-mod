...
.method public static checkAsmExperimental(Ljava/lang/Object;)V
    ...
    .line 188
    invoke-static {v0}, Lorg/mvel2/asm/Constants;->isWhitelisted(Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lorg/mvel2/asm/Constants;->checkIsPreview(Ljava/io/InputStream;)V
...
.method public static checkIsPreview(Ljava/io/InputStream;)V
    ...
    .line 217
    :cond_0
    const-string p0, "ASM9_EXPERIMENTAL can only be used by classes compiled with --enable-preview"
...
.method public static isWhitelisted(Ljava/lang/String;)Z
    ...
    const-string v0, "org/mvel2/asm/util/Trace(Annotation|Class|Field|Method|Module|RecordComponent|Signature)Visitor(\\$.*)?"
    ...
    const-string v0, "org/mvel2/asm/util/Check(Annotation|Class|Field|Method|Module|RecordComponent|Signature)Adapter(\\$.*)?"
