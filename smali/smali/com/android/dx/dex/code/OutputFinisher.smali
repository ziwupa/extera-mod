...
.method private align64bits([Lcom/android/dx/dex/code/Dop;)V
    ...
    check-cast v10, Lcom/android/dx/dex/code/DalvInsn;

    .line 846
    invoke-virtual {v10}, Lcom/android/dx/dex/code/DalvInsn;->getRegisters()Lcom/android/dx/rop/code/RegisterSpecList;
    ...
    .line 848
    invoke-virtual {v10, v11}, Lcom/android/dx/rop/code/RegisterSpecList;->get(I)Lcom/android/dx/rop/code/RegisterSpec;

    move-result-object v12

    .line 849
    invoke-virtual {v12}, Lcom/android/dx/rop/code/RegisterSpec;->isCategory2()Z
    ...
    .line 851
    :goto_1
    invoke-virtual {v12}, Lcom/android/dx/rop/code/RegisterSpec;->isEvenRegister()Z
    ...
    .line 870
    invoke-direct {p0, v9}, Lcom/android/dx/dex/code/OutputFinisher;->addReservedRegisters(I)V
    ...
    .line 872
    invoke-direct {p0, v9}, Lcom/android/dx/dex/code/OutputFinisher;->addReservedParameters(I)V
...
.method private fixBranches()Z
    ...
    .line 788
    :cond_2
    const-string/jumbo p0, "method too long"
    ...
    .line 818
    :catch_0
    const-string/jumbo p0, "unpaired TargetInsn"
    ...
    .line 814
    :catch_1
    const-string/jumbo p0, "unpaired TargetInsn (dangling)"
...
.method private performExpansion([Lcom/android/dx/dex/code/Dop;)Ljava/util/ArrayList;
    ...
    .line 677
    invoke-virtual {v7}, Lcom/android/dx/dex/code/Dop;->getFormat()Lcom/android/dx/dex/code/InsnFormat;

    move-result-object v8

    invoke-virtual {v8, v5}, Lcom/android/dx/dex/code/InsnFormat;->compatibleRegs(Lcom/android/dx/dex/code/DalvInsn;)Ljava/util/BitSet;

    move-result-object v8

    .line 678
    invoke-virtual {v5, v8}, Lcom/android/dx/dex/code/DalvInsn;->expandedPrefix(Ljava/util/BitSet;)Lcom/android/dx/dex/code/DalvInsn;

    move-result-object v9

    .line 679
    invoke-virtual {v5, v8}, Lcom/android/dx/dex/code/DalvInsn;->expandedSuffix(Ljava/util/BitSet;)Lcom/android/dx/dex/code/DalvInsn;

    move-result-object v10

    .line 682
    invoke-virtual {v5, v8}, Lcom/android/dx/dex/code/DalvInsn;->expandedVersion(Ljava/util/BitSet;)Lcom/android/dx/dex/code/DalvInsn;
    ...
    .line 685
    :goto_1
    instance-of v9, v5, Lcom/android/dx/dex/code/CodeAddress;
    ...
    .line 700
    :cond_2
    instance-of v8, v5, Lcom/android/dx/dex/code/ZeroSizeInsn;
    ...
    .line 708
    invoke-virtual {v5, v7}, Lcom/android/dx/dex/code/DalvInsn;->withOpcode(Lcom/android/dx/dex/code/Dop;)Lcom/android/dx/dex/code/DalvInsn;
...
.method public assignIndices(Lcom/android/dx/dex/code/DalvCode$AssignIndicesCallback;)V
    ...
    .line 322
    instance-of v3, v2, Lcom/android/dx/dex/code/CstInsn;
    ...
    .line 324
    :cond_1
    instance-of v3, v2, Lcom/android/dx/dex/code/MultiCstInsn;
...
.method public getAllConstants()Ljava/util/HashSet;
    ...
    .line 168
    invoke-static {v0, v3}, Lcom/android/dx/dex/code/OutputFinisher;->addConstants(Ljava/util/HashSet;Lcom/android/dx/dex/code/DalvInsn;)V
...
.method public reverseBranch(ILcom/android/dx/dex/code/CodeAddress;)V
    ...
    .line 303
    :catch_0
    const-string/jumbo p0, "non-reversible instruction"
    ...
    .line 300
    :catch_1
    const-string/jumbo p0, "too few instructions"
