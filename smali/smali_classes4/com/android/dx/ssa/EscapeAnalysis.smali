...
.method private movePropagate()V
    ...
    .line 682
    invoke-virtual {v6, v5}, Lcom/android/dx/ssa/SsaInsn;->mapSourceRegisters(Lcom/android/dx/ssa/RegisterMapper;)V
...
.method private replaceNode(Lcom/android/dx/ssa/EscapeAnalysis$EscapeSet;Lcom/android/dx/ssa/EscapeAnalysis$EscapeSet;)V
    ...
    .line 190
    iget-object v4, v3, Lcom/android/dx/ssa/EscapeAnalysis$EscapeSet;->childSets:Ljava/util/ArrayList;
    ...
    .line 192
    iget-object v4, p1, Lcom/android/dx/ssa/EscapeAnalysis$EscapeSet;->parentSets:Ljava/util/ArrayList;
    ...
    .line 195
    iget-object v3, v2, Lcom/android/dx/ssa/EscapeAnalysis$EscapeSet;->parentSets:Ljava/util/ArrayList;
    ...
    .line 197
    iget-object v3, p1, Lcom/android/dx/ssa/EscapeAnalysis$EscapeSet;->childSets:Ljava/util/ArrayList;
...
.method private run()V
    ...
    check-cast v4, Lcom/android/dx/ssa/EscapeAnalysis$EscapeSet;

    .line 716
    iget-object v5, v4, Lcom/android/dx/ssa/EscapeAnalysis$EscapeSet;->escape:Lcom/android/dx/ssa/EscapeAnalysis$EscapeState;
    ...
    .line 717
    iget-object v5, v4, Lcom/android/dx/ssa/EscapeAnalysis$EscapeSet;->childSets:Ljava/util/ArrayList;
    ...
    check-cast v8, Lcom/android/dx/ssa/EscapeAnalysis$EscapeSet;

    .line 718
    iget-object v9, v4, Lcom/android/dx/ssa/EscapeAnalysis$EscapeSet;->escape:Lcom/android/dx/ssa/EscapeAnalysis$EscapeState;

    iget-object v10, v8, Lcom/android/dx/ssa/EscapeAnalysis$EscapeSet;->escape:Lcom/android/dx/ssa/EscapeAnalysis$EscapeState;
    ...
    iput-object v9, v8, Lcom/android/dx/ssa/EscapeAnalysis$EscapeSet;->escape:Lcom/android/dx/ssa/EscapeAnalysis$EscapeState;
...
.method private scalarReplacement()V
    ...
    .line 479
    iget-boolean v5, v4, Lcom/android/dx/ssa/EscapeAnalysis$EscapeSet;->replaceableArray:Z
    ...
    .line 484
    :cond_1
    iget-object v4, v4, Lcom/android/dx/ssa/EscapeAnalysis$EscapeSet;->regSet:Ljava/util/BitSet;
    ...
    invoke-virtual {v5, v4}, Lcom/android/dx/ssa/SsaMethod;->getDefinitionForRegister(I)Lcom/android/dx/ssa/SsaInsn;

    move-result-object v5

    .line 486
    invoke-direct {p0, v5}, Lcom/android/dx/ssa/EscapeAnalysis;->getInsnForMove(Lcom/android/dx/ssa/SsaInsn;)Lcom/android/dx/ssa/SsaInsn;
    ...
    .line 490
    check-cast v7, Lcom/android/dx/rop/cst/CstLiteralBits;

    invoke-virtual {v7}, Lcom/android/dx/rop/cst/CstLiteralBits;->getIntBits()I
    ...
    .line 496
    invoke-direct {p0, v5, v6, v7, v8}, Lcom/android/dx/ssa/EscapeAnalysis;->replaceDef(Lcom/android/dx/ssa/SsaInsn;Lcom/android/dx/ssa/SsaInsn;ILjava/util/ArrayList;)V
    ...
    invoke-virtual {v5, v4}, Lcom/android/dx/ssa/SsaMethod;->getUseListForRegister(I)Ljava/util/List;
    ...
    .line 506
    invoke-direct {p0, v5, v6, v8, v9}, Lcom/android/dx/ssa/EscapeAnalysis;->replaceUse(Lcom/android/dx/ssa/SsaInsn;Lcom/android/dx/ssa/SsaInsn;Ljava/util/ArrayList;Ljava/util/HashSet;)V
    ...
    invoke-virtual {v4, v9}, Lcom/android/dx/ssa/SsaMethod;->deleteInsns(Ljava/util/Set;)V

    .line 512
    iget-object v4, p0, Lcom/android/dx/ssa/EscapeAnalysis;->ssaMeth:Lcom/android/dx/ssa/SsaMethod;

    invoke-virtual {v4}, Lcom/android/dx/ssa/SsaMethod;->onInsnsChanged()V
    ...
    invoke-static {v4, v5}, Lcom/android/dx/ssa/SsaConverter;->updateSsaMethod(Lcom/android/dx/ssa/SsaMethod;I)V
