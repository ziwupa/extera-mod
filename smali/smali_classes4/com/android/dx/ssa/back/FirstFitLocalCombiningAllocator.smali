...
.method private canMapRegs(Ljava/util/ArrayList;I)Z
    ...
    .line 658
    :cond_1
    invoke-direct {p0, v3, p2}, Lcom/android/dx/ssa/back/FirstFitLocalCombiningAllocator;->canMapReg(Lcom/android/dx/rop/code/RegisterSpec;I)Z
...
.method private handleCheckCastResults()V
    ...
    invoke-virtual {v4}, Lcom/android/dx/ssa/SsaBasicBlock;->getPredecessors()Ljava/util/BitSet;
    ...
    invoke-virtual {v12, v6}, Lcom/android/dx/ssa/BasicRegisterMapper;->oldToNew(I)I

    move-result v12

    .line 572
    invoke-direct {p0, v7, v12, v10}, Lcom/android/dx/ssa/back/FirstFitLocalCombiningAllocator;->tryMapReg(Lcom/android/dx/rop/code/RegisterSpec;II)Z
    ...
    .line 575
    iget-object v11, p0, Lcom/android/dx/ssa/back/FirstFitLocalCombiningAllocator;->mapper:Lcom/android/dx/ssa/InterferenceRegisterMapper;

    invoke-virtual {v11, v9}, Lcom/android/dx/ssa/BasicRegisterMapper;->oldToNew(I)I

    move-result v11

    .line 576
    invoke-direct {p0, v5, v11, v10}, Lcom/android/dx/ssa/back/FirstFitLocalCombiningAllocator;->tryMapReg(Lcom/android/dx/rop/code/RegisterSpec;II)Z
    ...
    .line 581
    :cond_5
    iget v11, p0, Lcom/android/dx/ssa/back/FirstFitLocalCombiningAllocator;->paramRangeEnd:I

    invoke-direct {p0, v11, v10}, Lcom/android/dx/ssa/back/FirstFitLocalCombiningAllocator;->findNextUnreservedRopReg(II)I
    ...
    .line 587
    :goto_1
    invoke-direct {p0, v12, v11, v10, v2}, Lcom/android/dx/ssa/back/FirstFitLocalCombiningAllocator;->tryMapRegs(Ljava/util/ArrayList;IIZ)Z
    ...
    invoke-virtual {v5, v6}, Lcom/android/dx/ssa/BasicRegisterMapper;->oldToNew(I)I
    ...
    invoke-virtual {v6, v9}, Lcom/android/dx/ssa/BasicRegisterMapper;->oldToNew(I)I
    ...
    .line 603
    invoke-virtual {p0, v4, v7}, Lcom/android/dx/ssa/back/RegisterAllocator;->insertMoveBefore(Lcom/android/dx/ssa/SsaInsn;Lcom/android/dx/rop/code/RegisterSpec;)Lcom/android/dx/rop/code/RegisterSpec;

    move-result-object v7

    .line 602
    invoke-virtual {v6, v2, v7}, Lcom/android/dx/ssa/NormalSsaInsn;->changeOneSource(ILcom/android/dx/rop/code/RegisterSpec;)V
    ...
    invoke-direct {p0, v4, v5}, Lcom/android/dx/ssa/back/FirstFitLocalCombiningAllocator;->addMapping(Lcom/android/dx/rop/code/RegisterSpec;I)V
...
.method private handleInvokeRangeInsns()V
    ...
    .line 526
    invoke-direct {p0, v3}, Lcom/android/dx/ssa/back/FirstFitLocalCombiningAllocator;->adjustAndMapSourceRangeRange(Lcom/android/dx/ssa/NormalSsaInsn;)V
...
.method private handlePhiInsns()V
    ...
    .line 614
    invoke-direct {p0, v3}, Lcom/android/dx/ssa/back/FirstFitLocalCombiningAllocator;->processPhiInsn(Lcom/android/dx/ssa/PhiInsn;)V
...
.method private tryMapRegs(Ljava/util/ArrayList;IIZ)Z
    ...
    .line 341
    :cond_1
    invoke-direct {p0, v5, p2, p3}, Lcom/android/dx/ssa/back/FirstFitLocalCombiningAllocator;->tryMapReg(Lcom/android/dx/rop/code/RegisterSpec;II)Z
    ...
    invoke-direct {p0, p2, v4}, Lcom/android/dx/ssa/back/FirstFitLocalCombiningAllocator;->markReserved(II)V
