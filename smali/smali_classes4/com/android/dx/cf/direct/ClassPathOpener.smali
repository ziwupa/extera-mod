...
.method private processArchive(Ljava/io/File;)Z
    ...
    .line 268
    iget-object v10, p0, Lcom/android/dx/cf/direct/ClassPathOpener;->filter:Lcom/android/dx/cf/direct/ClassPathOpener$FileNameFilter;

    invoke-interface {v10, v9}, Lcom/android/dx/cf/direct/ClassPathOpener$FileNameFilter;->accept(Ljava/lang/String;)Z
    ...
    .line 276
    invoke-virtual {p1, v2, v4, v10}, Ljava/io/ByteArrayOutputStream;->write([BII)V
    ...
    invoke-interface {v10, v9, v11, v12, v8}, Lcom/android/dx/cf/direct/ClassPathOpener$Consumer;->processFileBytes(Ljava/lang/String;J[B)Z
