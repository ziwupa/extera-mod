...
.method private constructor <init>([Lcom/android/dex/Dex;Lcom/android/dx/merge/CollisionPolicy;Lcom/android/dx/command/dexer/DxContext;Lcom/android/dx/merge/DexMerger$WriterSizes;)V
    ...
    .line 152
    iget-object p0, p0, Lcom/android/dx/merge/DexMerger;->dexOut:Lcom/android/dex/Dex;

    invoke-virtual {p0}, Lcom/android/dex/Dex;->getNextSectionStart()I

    move-result p0

    iget p2, p1, Lcom/android/dex/TableOfContents;->dataOff:I

    sub-int/2addr p0, p2

    iput p0, p1, Lcom/android/dex/TableOfContents;->dataSize:I
...
.method private readSortableTypes([Lcom/android/dx/merge/SortableType;Lcom/android/dex/Dex;Lcom/android/dx/merge/IndexMap;)V
    ...
    const-string p1, "Multiple dex files define "
...
.method private transformClassDef(Lcom/android/dex/Dex;Lcom/android/dex/ClassDef;Lcom/android/dx/merge/IndexMap;)V
    ...
    .line 745
    invoke-virtual {v1, p1}, Lcom/android/dex/Dex$Section;->writeInt(I)V
...
.method private transformCode(Lcom/android/dex/Dex;Lcom/android/dex/Code;Lcom/android/dx/merge/IndexMap;)V
    ...
    invoke-virtual {v4, v6}, Lcom/android/dex/Dex$Section;->writeInt(I)V
...
.method private transformEncodedCatchHandler(Lcom/android/dex/Code$CatchHandler;Lcom/android/dx/merge/IndexMap;)V
    ...
    invoke-virtual {v2, v4}, Lcom/android/dex/Dex$Section;->writeSleb128(I)V
...
.method private transformStaticValues(Lcom/android/dex/Dex$Section;Lcom/android/dx/merge/IndexMap;)V
    ...
    invoke-virtual {p1, p0}, Lcom/android/dex/EncodedValue;->writeTo(Lcom/android/dex/Dex$Section;)V
...
.method private transformTries(Lcom/android/dex/Dex$Section;[Lcom/android/dex/Code$Try;[I)V
    ...
    .line 944
    invoke-virtual {v1}, Lcom/android/dex/Code$Try;->getStartAddress()I

    move-result v2

    invoke-virtual {p1, v2}, Lcom/android/dex/Dex$Section;->writeInt(I)V

    .line 945
    invoke-virtual {v1}, Lcom/android/dex/Code$Try;->getInstructionCount()I
    ...
    .line 946
    invoke-virtual {v1}, Lcom/android/dex/Code$Try;->getCatchHandlerIndex()I

    move-result v1

    aget v1, p3, v1

    invoke-virtual {p1, v1}, Lcom/android/dex/Dex$Section;->writeUnsignedShort(I)V
