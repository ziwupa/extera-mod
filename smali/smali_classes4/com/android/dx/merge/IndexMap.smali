...
.method public adjust(Lcom/android/dex/Annotation;)Lcom/android/dex/Annotation;
    ...
    iget-object p0, p0, Lcom/android/dx/merge/IndexMap;->target:Lcom/android/dex/Dex;

    invoke-virtual {p1}, Lcom/android/dex/Annotation;->getVisibility()B

    move-result p1

    new-instance v2, Lcom/android/dex/EncodedValue;
    ...
    invoke-direct {v2, v0}, Lcom/android/dex/EncodedValue;-><init>([B)V

    invoke-direct {v1, p0, p1, v2}, Lcom/android/dex/Annotation;-><init>(Lcom/android/dex/Dex;BLcom/android/dex/EncodedValue;)V
...
.method public adjust(Lcom/android/dex/CallSiteId;)Lcom/android/dex/CallSiteId;
    ...
    invoke-direct {v0, v1, p0}, Lcom/android/dex/CallSiteId;-><init>(Lcom/android/dex/Dex;I)V
...
.method public adjust(Lcom/android/dex/FieldId;)Lcom/android/dex/FieldId;
    ...
    invoke-direct {v0, v1, v2, v3, p0}, Lcom/android/dex/FieldId;-><init>(Lcom/android/dex/Dex;III)V
...
.method public adjust(Lcom/android/dex/MethodId;)Lcom/android/dex/MethodId;
    ...
    invoke-direct {v0, v1, v2, v3, p0}, Lcom/android/dex/MethodId;-><init>(Lcom/android/dex/Dex;III)V
...
.method public adjust(Lcom/android/dex/ProtoId;)Lcom/android/dex/ProtoId;
    ...
    invoke-direct {v0, v1, v2, v3, p0}, Lcom/android/dex/ProtoId;-><init>(Lcom/android/dex/Dex;III)V
...
.method public adjust(Lcom/android/dx/merge/SortableType;)Lcom/android/dx/merge/SortableType;
    ...
    invoke-direct {v0, v1, v2, p0}, Lcom/android/dx/merge/SortableType;-><init>(Lcom/android/dex/Dex;Lcom/android/dx/merge/IndexMap;Lcom/android/dex/ClassDef;)V
...
.method public adjustEncodedArray(Lcom/android/dex/EncodedValue;)Lcom/android/dex/EncodedValue;
    ...
    new-instance p0, Lcom/android/dex/EncodedValueReader;

    const/16 v2, 0x1c

    invoke-direct {p0, p1, v2}, Lcom/android/dex/EncodedValueReader;-><init>(Lcom/android/dex/EncodedValue;I)V

    invoke-static {v1, p0}, Lcom/android/dx/merge/IndexMap$EncodedValueTransformer;->access$000(Lcom/android/dx/merge/IndexMap$EncodedValueTransformer;Lcom/android/dex/EncodedValueReader;)V

    .line 268
    new-instance p0, Lcom/android/dex/EncodedValue;

    invoke-virtual {v0}, Lcom/android/dx/util/ByteArrayAnnotatedOutput;->toByteArray()[B

    move-result-object p1

    invoke-direct {p0, p1}, Lcom/android/dex/EncodedValue;-><init>([B)V
...
.method public adjustEncodedValue(Lcom/android/dex/EncodedValue;)Lcom/android/dex/EncodedValue;
    ...
    invoke-direct {p0, p1}, Lcom/android/dex/EncodedValueReader;-><init>(Lcom/android/dex/EncodedValue;)V

    invoke-virtual {v1, p0}, Lcom/android/dx/merge/IndexMap$EncodedValueTransformer;->transform(Lcom/android/dex/EncodedValueReader;)V
...
.method public adjustTypeList(Lcom/android/dex/TypeList;)Lcom/android/dex/TypeList;
    ...
    invoke-direct {v0, p0, p1}, Lcom/android/dex/TypeList;-><init>(Lcom/android/dex/Dex;[S)V
